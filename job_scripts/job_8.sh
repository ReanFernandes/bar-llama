...
echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
# Update eval status to running
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_1 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
fi
...
echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=greedy evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_025 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=trained"
fi

echo "Running evaluation with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
# Update eval status to running
python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "running"
...
if [ $EVAL_EXIT -eq 0 ]; then
    ...
    python3 /pfs/work7/workspace/scratch/fr_rf1031-model_temp_storage/bar-llama/scripts/update_eval_status.py 8 "seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained" "failed" $EVAL_EXIT "Evaluation failed"
    echo "Evaluation failed with config: seeds=seed_989 model=llama3 tokenizer=llama3 dataset=all_domains_1_samples generation=temp_06 evaluation_dataset=test_set_2 eval=number_list_answer_first_zero_shot_unstructured ++eval.quantisation_status=full_model ++eval.training_status=untrained"
fi
