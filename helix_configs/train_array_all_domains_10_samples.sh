...
#SBATCH --output=/home/fr/fr_fr/fr_rf1031/bar-llama/helix-finetuning-logs/ft_llama3_%A_%a.out
#SBATCH --error=/home/fr/fr_fr/fr_rf1031/bar-llama/helix-finetuning-logs/ft_llama3_%A_%a.err
...
import json
import os
with open("/home/fr/fr_fr/fr_rf1031/bar-llama/helix_configs/train_configs_all_domains_10_samples.json") as f:
    configs = json.load(f)
